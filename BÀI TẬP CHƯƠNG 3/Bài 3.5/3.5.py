import numpy as np
height = np.loadtxt('D:\\BÀI TẬP\\BÀI TẬP CHƯƠNG 3\\Bài 3.5\\heights_1.txt',delimiter=',',encoding='utf-8-sig')
weight = np.loadtxt('D:\\BÀI TẬP\\BÀI TẬP CHƯƠNG 3\\Bài 3.5\\weights_1.txt',delimiter=',',encoding='utf-8-sig')
